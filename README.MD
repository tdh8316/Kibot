...
## 교실 갱신 요청하기
Kibot client 는 애플리케이션 인스턴스가 시작될 때 마다 `client/share/classinfo.json` 에 연결을 시도합니다.
...
Flutter에서 사용하는 Dart 언어의 색이 [Github linguist](https://github.com/github/linguist) 에서 너무 이뻐요!
![dart-lang](./docs/dart-color.png)
